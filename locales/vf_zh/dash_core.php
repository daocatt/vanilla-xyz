...
$Definition['Branding & SEO'] = '营销';

$Definition['Organization'] = '公司/组织';
$Definition['OrgDescription'] = '你的公司/组织用于SEO信息和JSON+LD显示';
$Definition['LogoDisclaimer'] = '部分主题不使用此设置.';

$Definition['Mobile Banner Logo'] = '移动端 Logo';
$Definition['MobileLogoDescription'] = '显示在站点顶部.';
$Definition['Banner Image'] = '横幅图片';
$Definition['The default banner image across the site. This can be overriden on a per category basis.'] = '默认横幅图片. 每个分类可自定义设置.';
$Definition['Touch Icon'] = '应用图标';
$Definition['TouchIconDescription'] = '152px. iOS上收藏网站至手机桌面的时候显示. iOS会自动增加圆角和效果.';
$Definition['Share Image'] = '分享图片';
$Definition['ShareImageDescription'] = '默认分享图. 最小50*50, 建议200*200';
$Definition['Mobile Address Bar Color'] = '地址栏颜色';
$Definition['AddressBarColorDescription'] = '部分浏览器支持地址栏颜色';
$Definition['Defer Javascript Loading'] = '延迟加载JS';
$Definition['This setting loads the page before executing Javascript.'] = '开启后将在页面加载完成后执行Javascript.';
$Definition['More information'] = '更多信息';

$Definition['Photo'] = '照片';
$Definition['Default Type'] = '默认类型';
$Definition['Select the default type for this role, if any.'] = '选择角色类型';