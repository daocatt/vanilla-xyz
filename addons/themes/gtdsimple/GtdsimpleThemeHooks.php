...
/**
 * Class GtdsimpleThemeHooks
 */
class GtdsimpleThemeHooks extends \Gdn_Plugin {
    ...
    public function setup() {
        saveToConfig([ 'Garden.MobileTheme' => 'gtdsimple' ]);
    }
    ...
    public function settingsController_afterCustomStyles_handler($sender) {
        $form = $sender->Form;
        echo $this->renderTwig("@gtdsimple/customStyles.twig", ['form' => new TwigFormWrapper($form)]);
    }
